...
/**
 * Removes friendship between two users (symmetric)
 */
public class UnfriendRequest implements Request {
    ...
    public void execute(FriendshipMap friendshipMap, StateStorage stateStorage) {
        friendshipMap.removeFriendship(user1, user2);
    }

    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof UnfriendRequest that)) return false;
